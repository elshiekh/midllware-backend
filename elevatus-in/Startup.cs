...
using elevatus_in.Helper;
using elevatus_in.Service;
...
namespace elevatus_in
{
    public class Startup
    {
        //MW
        // WebAPIProject properties = new WebAPIProject() { Id = 8, Code = 8, Name = "HMGOnBaseOut", UserName = "HmgOnBase" };
        WebAPIProject properties = new WebAPIProject() { Id = 211, Code = 211, Name = " elevatusIn", UserName = "elevatusIn" };
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Elevatus-In API");
