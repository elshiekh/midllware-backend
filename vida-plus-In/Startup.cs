...
using vida_plus_In.Service;

namespace vida_plus_In
{
    public class Startup
    {
        WebAPIProject properties = new WebAPIProject() { Id = 218, Code = 218, Name = "vida-plus-In", UserName = "vida-plus-In" };
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "vida-plus-In API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "vida-plus-In API");
