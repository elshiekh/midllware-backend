...
namespace elevatus_out.JobCategory
{

    #region New-JobCategory
    ...
    public class DeleteJobCategoryRequest
    {
        public List<string> system_id { get; set; }
    }
    // Response --------
    public class NewJobCategoryResponse
    {
        public Identifiers Identifiers { get; set; }
        public IntegrateAccountJobCategory IntegrateAccount { get; set; }
    ...
    public class DeleteJobCategoryResponse {
        public IdentifierDeleteResponse Identifiers { get; set; }
    }
    #endregion

    #region GET-JobCategory-RESPONSE
    ...
    public class IntegrateAccountJobCategory
    {
    ...
    public class CreateResponseJobCategory
    {
        public string Status { get; set; }
