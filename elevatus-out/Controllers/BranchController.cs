...
//                    result.Message = data.Identifiers.Status=="success"? "New Branch Successfully":"";
...
//                    result.Message = data.Identifiers.Status == "success" ? "Updated Branch Successfully": "";
//                    result.Status = data.Identifiers.Status;
...
//                    result.Message = data.Identifiers.Status == "success" ? "Delete Branch Successfully" : "";
//                    result.Status = data.Identifiers.Status;
//                    return Ok(result);
//                }
//            }
