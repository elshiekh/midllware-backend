...
namespace ePharmacy_In
{
    public class Startup
    {
        ...
        //MW
        WebAPIProject properties = new WebAPIProject() { Id = 215, Code = 215, Name = " ePharmacyIn", UserName = "ePharmacyIn" };
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ePharmacy-In API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ePharmacy-In API");
