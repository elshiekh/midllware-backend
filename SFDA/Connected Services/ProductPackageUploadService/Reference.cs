...
namespace ProductPackageUploadService
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://dtts.sfda.gov.sa/PackageUploadService", ConfigurationName="ProductPackageUploadService.PackageUploadService")]
    public interface PackageUploadService
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/PackageUploadService/PackageUploadService/uploadFileReque" +
            ...
            "nse")]
        [System.ServiceModel.FaultContractAttribute(typeof(ProductPackageUploadService.faultBean), Action="http://dtts.sfda.gov.sa/PackageUploadService/PackageUploadService/uploadFile/Faul" +
            "t/ServiceError", Name="ServiceError")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ProductPackageUploadService.uploadFileResponse uploadFile(ProductPackageUploadService.uploadFileRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/PackageUploadService/PackageUploadService/uploadFileReque" +
            "st", ReplyAction="http://dtts.sfda.gov.sa/PackageUploadService/PackageUploadService/uploadFileRespo" +
            "nse")]
        System.Threading.Tasks.Task<ProductPackageUploadService.uploadFileResponse> uploadFileAsync(ProductPackageUploadService.uploadFileRequest request);
    }
    ...
    public partial class uploadFileRequest
    {
        ...
        public ProductPackageUploadService.packageUploadServiceRequest PackageUploadServiceRequest;
        
        public uploadFileRequest()
        {
        }
        
        public uploadFileRequest(ProductPackageUploadService.packageUploadServiceRequest PackageUploadServiceRequest)
        {
    ...
    public partial class uploadFileResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://dtts.sfda.gov.sa/PackageUploadService", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public ProductPackageUploadService.packageUploadServiceResponse PackageUploadServiceResponse;
        
        public uploadFileResponse()
        {
        }
        
        public uploadFileResponse(ProductPackageUploadService.packageUploadServiceResponse PackageUploadServiceResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface PackageUploadServiceChannel : ProductPackageUploadService.PackageUploadService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class PackageUploadServiceClient : System.ServiceModel.ClientBase<ProductPackageUploadService.PackageUploadService>, ProductPackageUploadService.PackageUploadService
    {
        ...
        public ProductPackageUploadService.uploadFileResponse uploadFile(ProductPackageUploadService.uploadFileRequest request)
        {
            return base.Channel.uploadFile(request);
        }
        
        public System.Threading.Tasks.Task<ProductPackageUploadService.uploadFileResponse> uploadFileAsync(ProductPackageUploadService.uploadFileRequest request)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.PackageUploadService))
            {
                return new System.ServiceModel.EndpointAddress("http://tandtwstest.sfda.gov.sa:8080/ws/PackageUploadService/PackageUploadService");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
