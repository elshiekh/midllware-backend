...
namespace Pharmacy_SaleService
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://dtts.sfda.gov.sa/PharmacySaleService", ConfigurationName="Pharmacy_SaleService.PharmacySaleService")]
    public interface PharmacySaleService
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/PharmacySaleService/PharmacySaleService/notifyPharmacySal" +
            ...
            "eResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(Pharmacy_SaleService.faultBean), Action="http://dtts.sfda.gov.sa/PharmacySaleService/PharmacySaleService/notifyPharmacySal" +
            "e/Fault/ServiceError", Name="ServiceError")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Pharmacy_SaleService.notifyPharmacySaleResponse notifyPharmacySale(Pharmacy_SaleService.notifyPharmacySaleRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/PharmacySaleService/PharmacySaleService/notifyPharmacySal" +
            "eRequest", ReplyAction="http://dtts.sfda.gov.sa/PharmacySaleService/PharmacySaleService/notifyPharmacySal" +
            "eResponse")]
        System.Threading.Tasks.Task<Pharmacy_SaleService.notifyPharmacySaleResponse> notifyPharmacySaleAsync(Pharmacy_SaleService.notifyPharmacySaleRequest request);
    }
    ...
    public partial class notifyPharmacySaleRequest
    {
        ...
        public Pharmacy_SaleService.pharmacySaleServiceRequest PharmacySaleServiceRequest;
        
        public notifyPharmacySaleRequest()
        {
        }
        
        public notifyPharmacySaleRequest(Pharmacy_SaleService.pharmacySaleServiceRequest PharmacySaleServiceRequest)
        {
    ...
    public partial class notifyPharmacySaleResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://dtts.sfda.gov.sa/PharmacySaleService", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public Pharmacy_SaleService.pharmacySaleServiceResponse PharmacySaleServiceResponse;
        
        public notifyPharmacySaleResponse()
        {
        }
        
        public notifyPharmacySaleResponse(Pharmacy_SaleService.pharmacySaleServiceResponse PharmacySaleServiceResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface PharmacySaleServiceChannel : Pharmacy_SaleService.PharmacySaleService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class PharmacySaleServiceClient : System.ServiceModel.ClientBase<Pharmacy_SaleService.PharmacySaleService>, Pharmacy_SaleService.PharmacySaleService
    {
        ...
        public Pharmacy_SaleService.notifyPharmacySaleResponse notifyPharmacySale(Pharmacy_SaleService.notifyPharmacySaleRequest request)
        {
            return base.Channel.notifyPharmacySale(request);
        }
        
        public System.Threading.Tasks.Task<Pharmacy_SaleService.notifyPharmacySaleResponse> notifyPharmacySaleAsync(Pharmacy_SaleService.notifyPharmacySaleRequest request)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.PharmacySaleService))
            {
                return new System.ServiceModel.EndpointAddress("http://tandtwstest.sfda.gov.sa:8080/ws/PharmacySaleService/PharmacySaleService");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
