...
namespace ProductPackageDownloadService
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://dtts.sfda.gov.sa/PackageDownloadService", ConfigurationName="ProductPackageDownloadService.PackageDownloadService")]
    public interface PackageDownloadService
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/PackageDownloadService/PackageDownloadService/downloadFil" +
            ...
            "eResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(ProductPackageDownloadService.faultBean), Action="http://dtts.sfda.gov.sa/PackageDownloadService/PackageDownloadService/downloadFil" +
            "e/Fault/ServiceError", Name="ServiceError")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ProductPackageDownloadService.downloadFileResponse downloadFile(ProductPackageDownloadService.downloadFileRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/PackageDownloadService/PackageDownloadService/downloadFil" +
            "eRequest", ReplyAction="http://dtts.sfda.gov.sa/PackageDownloadService/PackageDownloadService/downloadFil" +
            "eResponse")]
        System.Threading.Tasks.Task<ProductPackageDownloadService.downloadFileResponse> downloadFileAsync(ProductPackageDownloadService.downloadFileRequest request);
    }
    ...
    public partial class downloadFileRequest
    {
        ...
        public ProductPackageDownloadService.packageDownloadServiceRequest PackageDownloadServiceRequest;
        
        public downloadFileRequest()
        {
        }
        
        public downloadFileRequest(ProductPackageDownloadService.packageDownloadServiceRequest PackageDownloadServiceRequest)
        {
    ...
    public partial class downloadFileResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://dtts.sfda.gov.sa/PackageDownloadService", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public ProductPackageDownloadService.packageDownloadServiceResponse PackageDownloadServiceResponse;
        
        public downloadFileResponse()
        {
        }
        
        public downloadFileResponse(ProductPackageDownloadService.packageDownloadServiceResponse PackageDownloadServiceResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface PackageDownloadServiceChannel : ProductPackageDownloadService.PackageDownloadService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class PackageDownloadServiceClient : System.ServiceModel.ClientBase<ProductPackageDownloadService.PackageDownloadService>, ProductPackageDownloadService.PackageDownloadService
    {
        ...
        public ProductPackageDownloadService.downloadFileResponse downloadFile(ProductPackageDownloadService.downloadFileRequest request)
        {
            return base.Channel.downloadFile(request);
        }
        
        public System.Threading.Tasks.Task<ProductPackageDownloadService.downloadFileResponse> downloadFileAsync(ProductPackageDownloadService.downloadFileRequest request)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.PackageDownloadService))
            {
                return new System.ServiceModel.EndpointAddress("http://tandtwstest.sfda.gov.sa:8080/ws/PackageDownloadService/PackageDownloadServ" +
                        "ice");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
