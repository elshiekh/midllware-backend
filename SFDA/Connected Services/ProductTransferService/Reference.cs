...
namespace ProductTransferService
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://dtts.sfda.gov.sa/TransferService", ConfigurationName="ProductTransferService.TransferService")]
    public interface TransferService
    {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(ProductTransferService.faultBean), Action="http://dtts.sfda.gov.sa/TransferService/TransferService/notifyTransfer/Fault/Serv" +
            "iceError", Name="ServiceError")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ProductTransferService.notifyTransferResponse notifyTransfer(ProductTransferService.notifyTransferRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/TransferService/TransferService/notifyTransferRequest", ReplyAction="http://dtts.sfda.gov.sa/TransferService/TransferService/notifyTransferResponse")]
        System.Threading.Tasks.Task<ProductTransferService.notifyTransferResponse> notifyTransferAsync(ProductTransferService.notifyTransferRequest request);
    }
    ...
    public partial class notifyTransferRequest
    {
        ...
        public ProductTransferService.transferServiceRequest TransferServiceRequest;
        
        public notifyTransferRequest()
        {
        }
        
        public notifyTransferRequest(ProductTransferService.transferServiceRequest TransferServiceRequest)
        {
    ...
    public partial class notifyTransferResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://dtts.sfda.gov.sa/TransferService", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public ProductTransferService.transferServiceResponse TransferServiceResponse;
        
        public notifyTransferResponse()
        {
        }
        
        public notifyTransferResponse(ProductTransferService.transferServiceResponse TransferServiceResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface TransferServiceChannel : ProductTransferService.TransferService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class TransferServiceClient : System.ServiceModel.ClientBase<ProductTransferService.TransferService>, ProductTransferService.TransferService
    {
        ...
        public ProductTransferService.notifyTransferResponse notifyTransfer(ProductTransferService.notifyTransferRequest request)
        {
            return base.Channel.notifyTransfer(request);
        }
        
        public System.Threading.Tasks.Task<ProductTransferService.notifyTransferResponse> notifyTransferAsync(ProductTransferService.notifyTransferRequest request)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.TransferService))
            {
                return new System.ServiceModel.EndpointAddress("http://tandtwstest.sfda.gov.sa:8080/ws/TransferService/TransferService");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
