...
namespace CityService
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://dtts.sfda.gov.sa/CityListService", ConfigurationName="CityService.CityListService")]
    public interface CityListService
    {
        
        // CODEGEN: Generating message contract since the operation getCityList is neither RPC nor document wrapped.
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(CityService.faultBean), Action="http://dtts.sfda.gov.sa/CityListService/CityListService/getCityList/Fault/Service" +
            "Error", Name="ServiceError")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        CityService.getCityListResponse getCityList(CityService.getCityListRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/CityListService/CityListService/getCityListRequest", ReplyAction="http://dtts.sfda.gov.sa/CityListService/CityListService/getCityListResponse")]
        System.Threading.Tasks.Task<CityService.getCityListResponse> getCityListAsync(CityService.getCityListRequest request);
    }
    ...
    public partial class getCityListRequest
    {
        ...
        public CityService.cityListServiceRequest CityListServiceRequest;
        
        public getCityListRequest()
        {
        }
        
        public getCityListRequest(CityService.cityListServiceRequest CityListServiceRequest)
        {
    ...
    public partial class getCityListResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://dtts.sfda.gov.sa/CityListService", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public CityService.cityListServiceResponse CityListServiceResponse;
        
        public getCityListResponse()
        {
        }
        
        public getCityListResponse(CityService.cityListServiceResponse CityListServiceResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface CityListServiceChannel : CityService.CityListService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class CityListServiceClient : System.ServiceModel.ClientBase<CityService.CityListService>, CityService.CityListService
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CityService.getCityListResponse CityService.CityListService.getCityList(CityService.getCityListRequest request)
        {
            return base.Channel.getCityList(request);
        }
        
        public CityService.cityListServiceResponse getCityList(CityService.cityListServiceRequest CityListServiceRequest)
        {
            CityService.getCityListRequest inValue = new CityService.getCityListRequest();
            inValue.CityListServiceRequest = CityListServiceRequest;
            CityService.getCityListResponse retVal = ((CityService.CityListService)(this)).getCityList(inValue);
            return retVal.CityListServiceResponse;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CityService.getCityListResponse> CityService.CityListService.getCityListAsync(CityService.getCityListRequest request)
        {
            return base.Channel.getCityListAsync(request);
        }
        
        public System.Threading.Tasks.Task<CityService.getCityListResponse> getCityListAsync(CityService.cityListServiceRequest CityListServiceRequest)
        {
            CityService.getCityListRequest inValue = new CityService.getCityListRequest();
            inValue.CityListServiceRequest = CityListServiceRequest;
            return ((CityService.CityListService)(this)).getCityListAsync(inValue);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.CityListService))
            {
                return new System.ServiceModel.EndpointAddress("http://tandtwstest.sfda.gov.sa:8080/ws/CityListService/CityListService");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
