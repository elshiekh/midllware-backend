...
namespace PackageUploadpProductionService
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://dtts.sfda.gov.sa/PackageUploadService", ConfigurationName="PackageUploadpProductionService.PackageUploadService")]
    public interface PackageUploadService
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/PackageUploadService/PackageUploadService/uploadFileReque" +
            ...
            "nse")]
        [System.ServiceModel.FaultContractAttribute(typeof(PackageUploadpProductionService.faultBean), Action="http://dtts.sfda.gov.sa/PackageUploadService/PackageUploadService/uploadFile/Faul" +
            "t/ServiceError", Name="ServiceError")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        PackageUploadpProductionService.uploadFileResponse uploadFile(PackageUploadpProductionService.uploadFileRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/PackageUploadService/PackageUploadService/uploadFileReque" +
            "st", ReplyAction="http://dtts.sfda.gov.sa/PackageUploadService/PackageUploadService/uploadFileRespo" +
            "nse")]
        System.Threading.Tasks.Task<PackageUploadpProductionService.uploadFileResponse> uploadFileAsync(PackageUploadpProductionService.uploadFileRequest request);
    }
    ...
    public partial class uploadFileRequest
    {
        ...
        public PackageUploadpProductionService.packageUploadServiceRequest PackageUploadServiceRequest;
        
        public uploadFileRequest()
        {
        }
        
        public uploadFileRequest(PackageUploadpProductionService.packageUploadServiceRequest PackageUploadServiceRequest)
        {
    ...
    public partial class uploadFileResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://dtts.sfda.gov.sa/PackageUploadService", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public PackageUploadpProductionService.packageUploadServiceResponse PackageUploadServiceResponse;
        
        public uploadFileResponse()
        {
        }
        
        public uploadFileResponse(PackageUploadpProductionService.packageUploadServiceResponse PackageUploadServiceResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface PackageUploadServiceChannel : PackageUploadpProductionService.PackageUploadService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class PackageUploadServiceClient : System.ServiceModel.ClientBase<PackageUploadpProductionService.PackageUploadService>, PackageUploadpProductionService.PackageUploadService
    {
        ...
        public PackageUploadpProductionService.uploadFileResponse uploadFile(PackageUploadpProductionService.uploadFileRequest request)
        {
            return base.Channel.uploadFile(request);
        }
        
        public System.Threading.Tasks.Task<PackageUploadpProductionService.uploadFileResponse> uploadFileAsync(PackageUploadpProductionService.uploadFileRequest request)
        {
