...
namespace ErrorCodeListProductionService
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://dtts.sfda.gov.sa/ErrorCodeListService", ConfigurationName="ErrorCodeListProductionService.ErrorCodeListService")]
    public interface ErrorCodeListService
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/ErrorCodeListService/ErrorCodeListService/getErrorCodeLis" +
            ...
            "tResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(ErrorCodeListProductionService.faultBean), Action="http://dtts.sfda.gov.sa/ErrorCodeListService/ErrorCodeListService/getErrorCodeLis" +
            "t/Fault/ServiceError", Name="ServiceError")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ErrorCodeListProductionService.getErrorCodeListResponse getErrorCodeList(ErrorCodeListProductionService.getErrorCodeListRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/ErrorCodeListService/ErrorCodeListService/getErrorCodeLis" +
            "tRequest", ReplyAction="http://dtts.sfda.gov.sa/ErrorCodeListService/ErrorCodeListService/getErrorCodeLis" +
            "tResponse")]
        System.Threading.Tasks.Task<ErrorCodeListProductionService.getErrorCodeListResponse> getErrorCodeListAsync(ErrorCodeListProductionService.getErrorCodeListRequest request);
    }
    ...
    public partial class getErrorCodeListRequest
    {
        ...
        public ErrorCodeListProductionService.errorCodeListServiceRequest ErrorCodeListServiceRequest;
        
        public getErrorCodeListRequest()
        {
        }
        
        public getErrorCodeListRequest(ErrorCodeListProductionService.errorCodeListServiceRequest ErrorCodeListServiceRequest)
        {
    ...
    public partial class getErrorCodeListResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://dtts.sfda.gov.sa/ErrorCodeListService", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public ErrorCodeListProductionService.errorCodeListServiceResponse ErrorCodeListServiceResponse;
        
        public getErrorCodeListResponse()
        {
        }
        
        public getErrorCodeListResponse(ErrorCodeListProductionService.errorCodeListServiceResponse ErrorCodeListServiceResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface ErrorCodeListServiceChannel : ErrorCodeListProductionService.ErrorCodeListService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class ErrorCodeListServiceClient : System.ServiceModel.ClientBase<ErrorCodeListProductionService.ErrorCodeListService>, ErrorCodeListProductionService.ErrorCodeListService
    {
        ...
        public ErrorCodeListProductionService.getErrorCodeListResponse getErrorCodeList(ErrorCodeListProductionService.getErrorCodeListRequest request)
        {
            return base.Channel.getErrorCodeList(request);
        }
        
        public System.Threading.Tasks.Task<ErrorCodeListProductionService.getErrorCodeListResponse> getErrorCodeListAsync(ErrorCodeListProductionService.getErrorCodeListRequest request)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.ErrorCodeListService))
            {
                return new System.ServiceModel.EndpointAddress("https://rsd.sfda.gov.sa/ws/ErrorCodeListService/ErrorCodeListService");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
