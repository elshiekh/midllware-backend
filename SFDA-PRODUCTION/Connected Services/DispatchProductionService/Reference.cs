...
namespace DispatchProductionService
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://dtts.sfda.gov.sa/DispatchService", ConfigurationName="DispatchProductionService.DispatchService")]
    public interface DispatchService
    {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(DispatchProductionService.faultBean), Action="http://dtts.sfda.gov.sa/DispatchService/DispatchService/notifyDispatch/Fault/Serv" +
            "iceError", Name="ServiceError")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        DispatchProductionService.notifyDispatchResponse notifyDispatch(DispatchProductionService.notifyDispatchRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://dtts.sfda.gov.sa/DispatchService/DispatchService/notifyDispatchRequest", ReplyAction="http://dtts.sfda.gov.sa/DispatchService/DispatchService/notifyDispatchResponse")]
        System.Threading.Tasks.Task<DispatchProductionService.notifyDispatchResponse> notifyDispatchAsync(DispatchProductionService.notifyDispatchRequest request);
    }
    ...
    public partial class notifyDispatchRequest
    {
        ...
        public DispatchProductionService.dispatchServiceRequest DispatchServiceRequest;
        
        public notifyDispatchRequest()
        {
        }
        
        public notifyDispatchRequest(DispatchProductionService.dispatchServiceRequest DispatchServiceRequest)
        {
    ...
    public partial class notifyDispatchResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://dtts.sfda.gov.sa/DispatchService", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public DispatchProductionService.dispatchServiceResponse DispatchServiceResponse;
        
        public notifyDispatchResponse()
        {
        }
        
        public notifyDispatchResponse(DispatchProductionService.dispatchServiceResponse DispatchServiceResponse)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface DispatchServiceChannel : DispatchProductionService.DispatchService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class DispatchServiceClient : System.ServiceModel.ClientBase<DispatchProductionService.DispatchService>, DispatchProductionService.DispatchService
    {
        ...
        public DispatchProductionService.notifyDispatchResponse notifyDispatch(DispatchProductionService.notifyDispatchRequest request)
        {
            return base.Channel.notifyDispatch(request);
        }
        
        public System.Threading.Tasks.Task<DispatchProductionService.notifyDispatchResponse> notifyDispatchAsync(DispatchProductionService.notifyDispatchRequest request)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.DispatchService))
            {
                return new System.ServiceModel.EndpointAddress("https://rsd.sfda.gov.sa/ws/DispatchService/DispatchService");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
