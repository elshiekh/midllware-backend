...
namespace vida_plus_out.Controllers
{
    ...
    public class ReceiptController : ControllerBase
    {
        ...
        public ReceiptController(DBOption dbOption)
        {
            _dbOption = dbOption;
        }
        #endregion
        ...
        public async Task<IActionResult> ArReceipts([FromBody] ArReceiptsRequest obj)
        {
            try
            {
                ...
                var request = new HttpRequestMessage(HttpMethod.Post, "http://10.201.206.47:7014/api/erp/v1/finance/ar-receipts");
                ...
                var data = JsonConvert.DeserializeObject<ArReceiptsResponse>(stringData);
