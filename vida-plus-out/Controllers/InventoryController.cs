...
namespace vida_plus_out.Controllers
{
    ...
    public class InventoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertInventory([FromBody] List<InsertInventoryRequest> obj)
        {
            try
            {
        ...
        public async Task<IActionResult> UpdateInventory([FromBody] List<UpdateInventoryRequest> obj)
        {
            try
            {
                var client = new HttpClient();
